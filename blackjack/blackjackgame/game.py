...
# Lab 00-02
#
# This is the game module for the blackjack game.
#
...
class Game:
    ...
    def __init__(self, num_players, num_decks):
        ...
        for player_num in range(num_players):
            player_name = input("What is player " + str(player_num + 1) + "'s name? ")
    ...
    def player_bets(self):
        ...
        for player in self.players:
            ...
            if player.get_money() == 0:
                print(
                    "An anonymous donor has given $10,000 to " + player.get_name() + "!"
                )
                player.set_money(10000)
            print("=============================================")
            print(player.get_name() + "'s current balance: $" + str(player.get_money()))
            print("=============================================")
    ...
    def player_turn(self, player, dealer):
        ...
        while player.get_hit():
            ...
            if player.get_money() >= player.get_bet() * 2 and double_down_prompt:
...
def main_game_loop():
    ...
    while True:
        ...
        for player in blackjack_game.players:
            print("Player: " + player.get_name() + " Money: " + str(player.get_money()))
        print("Would you like to play again?(Y/N) ")
        if input().upper() == "Y":
            continue
        print(
            "Would you like to save your game? This will overwrite any previous save files. (Y/N) "
        )
        if input().upper() == "Y":
